...
public class ApsTokens {
    ...
    public static final Map<String, String> BRACES = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        map.put(CURLY_BRACES_START, CURLY_BRACES_END);
        map.put(ANGLE_BRACES_START, ANGLE_BRACES_END);
        map.put(BRACES_START, BRACES_END);
    });
    public static final Map<String, String> REVERSE_BRACES = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        map.put(CURLY_BRACES_END, CURLY_BRACES_START);
        map.put(ANGLE_BRACES_END, ANGLE_BRACES_START);
        map.put(BRACES_END, BRACES_START);
    });

    public static final Map<String, ApsFileKeyword> FILE_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsFileKeyword value : ApsFileKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsMemberParameterKeyword> MEMBER_PARAMETER_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsMemberParameterKeyword value : ApsMemberParameterKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsLocalVariableKeyword> LOCAL_VARIABLE_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsLocalVariableKeyword value : ApsLocalVariableKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsMethodKeyword> METHOD_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsMethodKeyword value : ApsMethodKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsMethodParamKeyword> METHOD_PARAM_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsMethodParamKeyword value : ApsMethodParamKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsClassKeyword> CLASS_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
        for (ApsClassKeyword value : ApsClassKeyword.values()) {
            map.put(value.literal(), value);
        }
    });

    public static final Map<String, ApsBinderKeyword> BINDER_KEYWORDS = QuickManipulate.operation(ApricotCollectionFactor.hashMap(), map -> {
