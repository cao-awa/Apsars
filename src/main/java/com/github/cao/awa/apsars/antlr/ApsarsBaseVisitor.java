...
public class ApsarsBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ApsarsVisitor<T> {
     ...
     */
    @Override
    public T visitClass(ApsarsParser.ClassContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitReturn(ApsarsParser.ReturnContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAlternateStaticAndFinalAndSync(ApsarsParser.AlternateStaticAndFinalAndSyncContext ctx) {
        return visitChildren(ctx);
    }
